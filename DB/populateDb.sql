...
INSERT INTO `Linguaggio` (`NomeLinguaggio`)
VALUES ('clike'),
       ('python'),
       ('javascript'),
       ('z80'),
...
INSERT INTO `ProdottoInVetrina` (`IdProdInVetrina`, `IdProd`, `IndicePopolarita`, `Descrizione`, `IdCategoria`)
VALUES (NULL, '8', '3',
        'In the mid-1990s, GeoCities was the first service to offer\nusers a free and easy way to create their own web content',
        '5');
