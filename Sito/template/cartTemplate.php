                ...
                <div class="col-10 col-md-5">
                    <a href="../editor.php?id=<?php echo $articolo["IdProd"] ?>">
                        <article>
                            ...
                            <div class="row">
                                <p class="col-12 font-weight-bold">Price:
                                    € <?php echo getPrice($articolo["Altezza"], $articolo["Larghezza"], $articolo["Quantità"]) ?></p>
                            </div>
                        </article>
                    </a>
                    <div class="row justify-content-center mt-2">
                        <label for="quantity<?php echo $articolo["IdProd"]; ?>">Quantity:</label><input
                                id="quantity<?php echo $articolo["IdProd"]; ?>" type="number" min="1" max=""
                                name="quantity" value="<?php echo $articolo["Quantità"]; ?>" title="Qty"
                                class="input-text text-center">
                    </div>
                    <div class="row justify-content-center mt-2 mb-4">
                        <a href="#" class="text-danger" id="delete<?php echo $articolo["IdProd"]; ?>"> Delete
                            Product </a>
                        <script>
